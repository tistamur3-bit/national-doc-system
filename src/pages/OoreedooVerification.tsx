      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="flex justify-center mb-6">
            <img src={ooredooHeader} alt="Ooredoo Header" className="w-full max-w-sm" />
          </div>
          ...
          <div className="bg-[#c0c0c0] rounded-lg shadow-lg p-8 border border-gray-200">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="البريد الالكتروني المسجل في تطبيق Ooredoo" {...register("email")} className={errors.email ? "border-destructive" : ""} dir="rtl" />
          ...
          <div className="flex justify-center mt-8">
            <img src={ooredooLogo} alt="Ooredoo Logo" className="h-16 object-contain" />
          </div>
        </div>
      </div>
    </div>;
